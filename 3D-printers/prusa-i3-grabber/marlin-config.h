...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,760}  // default steps per unit for prusa i3
#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {800,800,20,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
